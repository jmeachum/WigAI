...
**Returns:** type int - the size of the session bank.
...
**Parameters:**
- `index` (type int): the session index, must be in the range `[0..getSize-1]`

**Returns:** type GenericBrowsingSession - the requested browser session object

...
**Extends:** `com.bitwig.extension.controller.api.BitwigBrowsingSession`
...
**Returns:** type BrowserFilterColumn - the requested category filter object.

### getPresetTypeFilter()

Returns the preset type filter as shown in the category column of the browser.

**Returns:** type BrowserFilterColumn - the requested preset type filter object.

### getFileTypeFilter()

Returns the file type filter as shown in the category column of the browser.

**Returns:** type BrowserFilterColumn - the requested file type filter object.

### getCreatorFilter()

Returns the creator filter as shown in the category column of Bitwig Studio's contextual browser.

**Returns:** type BrowserFilterColumn - the requested creator filter object.

### getTagsFilter()

Returns the tags filter as shown in the category column of Bitwig Studio's contextual browser.

**Returns:** type BrowserFilterColumn - the requested tags filter object.

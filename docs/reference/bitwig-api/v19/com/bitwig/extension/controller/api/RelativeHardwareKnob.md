...
**Extends:** `com.bitwig.extension.controller.api.RelativeHardwareControl`
...
Sets the sensitivity of this hardware control. The default sensitivity is 1. This value is a multiplied
 with the adjustment coming from the RelativeHardwareValueMatcher to determine the final
 adjustment amount.
...
### setAdjustValueMatcher(com.bitwig.extension.controller.api.RelativeHardwareValueMatcher)

Sets the RelativeHardwareValueMatcher that can be used to detect when the user adjusts the
 hardware control's value.

**Parameters:**
- `matcher` (type RelativeHardwareValueMatcher)

**Returns:** type void

### addBindingWithSensitivity(com.bitwig.extension.controller.api.RelativeHardwarControlBindable,double)

Adds a binding to the supplied target with the supplied sensitivity.

**Parameters:**
- `target` (type RelativeHardwarControlBindable)
- `sensitivity` (type double)

**Returns:** type RelativeHardwareControlBinding

### setBindingWithSensitivity(com.bitwig.extension.controller.api.RelativeHardwarControlBindable,double)
...
### addBindingWithRange(com.bitwig.extension.controller.api.SettableRangedValue,double,double)
...
**Parameters:**
- `target` (type SettableRangedValue)
- `minNormalizedValue` (type double)
- `maxNormalizedValue` (type double)

**Returns:** type RelativeHardwareControlBinding

### setBindingWithRange(com.bitwig.extension.controller.api.SettableRangedValue,double,double)
...
### addBindingWithRangeAndSensitivity(com.bitwig.extension.controller.api.SettableRangedValue,double,double,double)
...
### setBindingWithRangeAndSensitivity(com.bitwig.extension.controller.api.SettableRangedValue,double,double,double)

...
**Parameters:**
- `name` (type String): a textual representation of the new time signature value, formatted as
...
**Returns:** type SettableIntegerValue - an integer value object that represents the time signature numerator.
...
**Returns:** type SettableIntegerValue - an integer value object that represents the time signature denominator.
...
**Returns:** type SettableIntegerValue - an integer value object that represents the time signature ticks.

...
Represents some physical hardware element. Hardware elements can be HardwareControls (e.g. buttons,
 sliders etc) or HardwareOutputElements (e.g lights, text displays etc).

...
**Extends:** `com.bitwig.extension.controller.api.CursorChannel`, `com.bitwig.extension.controller.api.Track`, `com.bitwig.extension.controller.api.PinnableCursor`
...
### setCursorNavigationMode(com.bitwig.extension.controller.api.CursorNavigationMode)

Specifies the behaviour of the functions Cursor.selectPrevious(), Cursor.selectNext(),
 Cursor.selectFirst() and Cursor.selectLast(). Calling those functions can either navigate the cursor
...
**Parameters:**
- `mode` (type CursorNavigationMode)
...
**Returns:** type PinnableCursorDevice - the requested device selection cursor object
...
### createCursorDevice(java.lang.String,java.lang.String,int,com.bitwig.extension.controller.api.CursorDeviceFollowMode)

Creates a CursorDevice for this cursor track that by default follows a device based on the
 supplied follow mode.

**Parameters:**
- `id` (type String): An id that is used to identify this cursor.
- `name` (type String): A name that is displayed to the user for this cursor.
- `numSends` (type int): the number of sends that are simultaneously accessible in nested channels.
- `followMode` (type CursorDeviceFollowMode): Mode that defines how this cursor should follow devices.

**Returns:** type PinnableCursorDevice

### createLauncherCursorClip(int,int)

Creates a PinnableCursorClip for this track that follows a clip within the track on the clip
...
**Returns:** type PinnableCursorClip

### createLauncherCursorClip(java.lang.String,java.lang.String,int,int)
...
### selectChannel(com.bitwig.extension.controller.api.Channel)

Points the cursor to the given channel.

**Parameters:**
- `channel` (type Channel): the channel that this channel cursor should point to
